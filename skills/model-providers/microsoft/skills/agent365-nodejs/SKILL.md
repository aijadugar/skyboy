...
description: Node.js SDK components for Microsoft Agent 365 - observability, notifications, runtime utilities, and development tools.
license: MIT
---
...
Use this skill when building enterprise-grade agents with Microsoft Agent 365 SDK in Node.js/TypeScript. Covers observability, notifications, runtime utilities, and development tools for production agents across Microsoft 365 platforms.

## When it applies

- Building enterprise agents with Microsoft Agent 365 SDK in Node.js/TypeScript
