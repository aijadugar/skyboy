// Fuzzy search over the compact v2 catalog records. Mirrors the ranking the
// Go CLI and MCP server implement: token-overlap scoring over id, description,
// and tags, optionally filtered by category and compatible agent.
