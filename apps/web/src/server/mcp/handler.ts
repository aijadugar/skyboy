...
import { registerTools, READ_ONLY_TOOLS } from "./tools";
  ...
  const server = new McpServer(
    { name: "skyboy", version: "0.1.0" },
    {
      ...
      instructions:
        ...
        "Search, preview, list categories, and prepare context ZIP bundles. " +
        "Install is local-only (`skyboy mcp --transport stdio`).",
    }
  );
