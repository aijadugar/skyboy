  ...
  return (
    <div>
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <h1 className="max-w-5xl font-mono text-5xl font-bold leading-none tracking-normal md:text-7xl">{APP_NAME.toUpperCase()}</h1>
      ...
      <section className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="border-2 border-[var(--border)] bg-[var(--bg-card)] p-6 shadow-[3px_3px_0_var(--border)] transition-colors hover:border-[#00D2FF]">
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            <Link className="border-2 border-[var(--border)] px-4 py-2 shadow-[3px_3px_0_var(--border)] hover:border-[#00D2FF]" href={GITHUB_URL}>
              Star on GitHub ↗
            </Link>
